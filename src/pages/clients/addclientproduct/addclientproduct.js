            ...
            .then(data => {
                if (data.status == true) {
                    setTimeout(() => {
                        ...
                        this.setState({ type: '', selectedModules: [], cost: '', modules : [] })
                        setTimeout(() => {
            ...
            <div className="container mx-auto row">
                ...
                {this.state.successmessage ?
                    <div className="alert alert-success" role="alert" style={{ position: 'fixed', top: '70px', right: '10px', zIndex: '4' }}>
                        ...
                        <button type="button" className="close ml-4" data-dismiss="alert" aria-label="Close">
                ...
                <div className="col-md-10 offset-1 mb-3 mt-4" id="profile">
                    {/* Error Message */}
                                    ...
                                    this.state.modules.length > 0 ?
                                        this.state.modules.map(module => 
                                            <div className="col-md-4">
                                                <p className="list-group-item">{module.name} <label className="switch float-right"> <input type="checkbox" id={module.id} onClick={this.handleCheck} /><span className="slider round"></span>
                                                </label>
                                                </p>
                                            </div>
                                        )
