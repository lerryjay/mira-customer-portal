    ...
    return (
      <div className="container mx-auto row">
        <div className="col-md-12 mb-3 mt-4" id="profile">
              ...
              {/* <div className="card-header bg-light font-weight-bold text-dark">
                CLIENT PRODUCT DETAILS
              </div> */}

              <div className="w-100 text-center">
                <h3>CLIENT PRODUCT DETAILS </h3>
              </div>
                ...
                <div className="row mt-4">
                  ...
                  <div className="col-md-6 mt-5">
                      <h6> <span className="font-weight-bold">Product name:</span> Mira HPro</h6>
                      <h6> <span className="font-weight-bold">Total Cost:</span> &#8358;5000</h6>
                      <h6> <span className="font-weight-bold">License Coverage:</span> Annually</h6>
